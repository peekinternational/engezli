         ...
         <aside class="col col-xl-3 order-xl-1 col-lg-12 order-lg-1 col-12">
            <div class="box mb-3 shadow-sm rounded bg-white profile-box text-center">
               <div class="py-4 px-3 border-bottom">
                  <img src="{{asset('frontend-assets/images/user/s4.png')}}" class="img-fluid mt-2 rounded-circle" alt="Responsive image">
               ...
               <div class="box-body">
                  <div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
                     <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('frontend-assets/images/l4.png')}}" alt="">
                     </div>
                  ...
                  <div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
                     <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('frontend-assets/images/l8.png')}}" alt="">
                     </div>
                     <div class="font-weight-bold">
                  ...
                  <div class="d-flex align-items-center osahan-post-header p-3 people-list">
                     <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('frontend-assets/images/l5.png')}}" alt="">
                     </div>
                     <div class="font-weight-bold">
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
               ...
               <div class="box-body p-3 border-bottom">
                  <div class="d-flex align-items-top job-item-header pb-2">
                     ...
                     <img class="img-fluid ml-auto mb-auto" src="{{asset('frontend-assets/images/l3.png')}}" alt="">
                  </div>
               ...
               <div class="box-body p-3 border-bottom">
                  <div class="d-flex align-items-top job-item-header pb-2">
                     ...
                     <img class="img-fluid ml-auto mb-auto" src="{{asset('frontend-assets/images/l6.png')}}" alt="">
                  </div>
               ...
               <div class="box-body p-3">
                  <div class="d-flex align-items-top job-item-header pb-2">
                     ...
                     <img class="img-fluid ml-auto mb-auto" src="{{asset('frontend-assets/images/l2.png')}}" alt="">
                  </div>
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
               ...
               <div class="box-body p-3 border-bottom">
                  <div class="d-flex align-items-top job-item-header pb-2">
                     ...
                     <img class="img-fluid ml-auto mb-auto" src="{{asset('frontend-assets/images/e1.png')}}" alt="">
                  </div>
                  <p class="mb-0">Find the most qualified people in the most unexpected places. Information for applicants to consider when applying for local positions.</p>
               </div>
               <div class="box-body p-3">
                  <div class="d-flex align-items-top job-item-header pb-2">
                     ...
                     <img class="img-fluid ml-auto mb-auto" src="{{asset('frontend-assets/images/e2.png')}}" alt="">
                  </div>
         ...
         <aside class="col col-xl-3 order-xl-3 col-lg-12 order-lg-3 col-12">
            <div class="box shadow-sm rounded bg-white mb-3">
               ...
               <div class="box-body p-3">
                  <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                     <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('frontend-assets/images/user/s1.png')}}" alt="">
                  ...
                  <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                     <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('frontend-assets/images/user/s2.png')}}" alt="">
                        <div class="status-indicator bg-success"></div>
                     </div>
                     <div class="font-weight-bold mr-2">
                  ...
                  <div class="d-flex align-items-center osahan-post-header people-list">
                     <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="{{asset('frontend-assets/images/user/s5.png')}}" alt="">
                        <div class="status-indicator bg-success"></div>
                     </div>
                     <div class="font-weight-bold mr-2">
               ...
               <div class="shadow-sm rounded bg-white job-item mb-3">
                  ...
                  <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                     <div class="overlap-rounded-circle">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s5.png')}}" alt="" data-original-title="Sophia Lee">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s6.png')}}" alt="" data-original-title="John Doe">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s7.png')}}" alt="" data-original-title="Julia Cox">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s8.png')}}" alt="" data-original-title="John Doe">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s9.png')}}" alt="" data-original-title="Julia Cox">
            ...
            <a href="job-profile.html">
               <div class="shadow-sm rounded bg-white job-item mb-3">
                  ...
                  <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                     <div class="overlap-rounded-circle">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s1.png')}}" alt="" data-original-title="Sophia Lee">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s2.png')}}" alt="" data-original-title="John Doe">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s3.png')}}" alt="" data-original-title="Julia Cox">
                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top" title="" src="{{asset('frontend-assets/images/user/s4.png')}}" alt="" data-original-title="Robert Cook">
                     </div>
                     <span class="font-weight-bold text-muted">18 connections</span>
                  </div>
                  <div class="p-3 job-item-footer">
